...
if activate_obstacles == 1
    for i = 1:size(obstacle_centers,1)
        ...
        rectangle('Position', [params.obstacle_centers(i,1)-params.obstacle_size(1)/2-params.vehicle_length/2 params.obstacle_centers(i,2)-params.obstacle_size(2)/2-params.vehicle_width/2 params.obstacle_size(1)+params.vehicle_length params.obstacle_size(2)+params.vehicle_width]) 
    end
end
